...
def _upgrade_state_dict(state):
    ...
    if state["args"].task == "translation_multi_simple_epoch":
        print("Switching from translation_multi_simple_epoch --> sum_from_pretrained_bart")
        registry.set_defaults(state["args"], "sum_from_pretrained_bart")
    else:
