...
def add_preprocess_args(parser):
    ...
    ## Added for data for new auxiliary tasks
    parser.add_argument('--categories', action='store_true', default=False,
                        help='compute data of document categories')
    parser.add_argument('--catdict', type=str,
                        help='dictionary with document categories')
    parser.add_argument('--cloze', action='store_true', default=False,
                        help='cloze discourse')
    parser.add_argument('--langs', type=str, help="language ids we are considering", default=None) ## needed when preprocess masked tokens :(
...
def add_common_eval_args(group):
    ...
    group.add_argument('--temp-dir', metavar='TEMPDIR', type=str, default='/tmp/',
                       help='path to write temporal files if needed"')
