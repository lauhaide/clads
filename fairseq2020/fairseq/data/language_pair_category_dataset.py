...
def collate(
    ...
    if samples[0].get('category', None) is not None:
        category = merge('category', left_pad=left_pad_target)
        category = category.index_select(0, sort_order)
...
class CatLanguagePairDataset(FairseqDataset):
    """
    ...
    def __getitem__(self, index):
        ...
        cat_item = self.cat[index] if self.cat is not None else None
