...
class RoundRobinZipDatasets(FairseqDataset):
    ...
    def _map_index(self, key, index):
        ...
        #TODO: there is a bug with this % iteration and those filtered indices,
        # doing this operation we may fall in an index that has been filtered
        # and is not really included in the batch sampler. I'm not 100% clear
        # on this but there is an issue, for the moment just truncate source & targets
